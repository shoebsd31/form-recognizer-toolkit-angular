# Form Recognizer Toolkit - Labeling UX (Angular)

> **Note:** This repository is an Angular port of the original React-based [Form Recognizer Toolkit](https://github.com/microsoft/Form-Recognizer-Toolkit/) by Microsoft. The application has been mapped from the React app to an Angular app while preserving the same functionality.
>
> **Source repository:** https://github.com/shoebsd31/form-recognizer-toolkit-angular
...
```sh
git clone https://github.com/shoebsd31/form-recognizer-toolkit-angular.git
```
...
```sh
cd form-recognizer-toolkit-angular
npm i
```
